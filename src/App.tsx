    ...
    <div className="App">
      ...
      <div className="flex flex-row justify-between mt-[20px] mx-[20px] md:mx-[40px] lg:mx-[112px] ">
        <div className='flex flex-row items-center justify-center'>
          ...
          <img src={RegiM} alt={textContent.product_name} /></div>
        <div className='relative'>
          <Button label={textContent.cta_button} className="w-18 py-2.5 px-4 bg-[#0876DD] rounded-md text-[white]" /></div>
      </div>
      ...
      <div className='pt-[68px] md:pt-[100px] xl:flex xl:flex-row '>
        ...
        <div className='mt-6 relative'>
          <div className='bg-Secondary/100 h-[400px] w-[400px] rounded-full left-[80px] absolute md:h-[700px] md:w-[700px] md:left-[156px] md:bottom-12 lg:z-[-1] lg:left-[-120px] lg:bottom-50'>
          </div>
      ...
      <div className='h-0.5   mt-20 mb-14 bg-Neutral/200 mx-5' />
      <div className='flex flex-col gap-14   items-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <button className='rounded-full  bg-White -top-4 relative flex gap-3 py-3 pr-4 pl-3  md:py-4 md:pr-5 md:pl-4'>
      ...
      <div className='bg-Neutral/900 pt-3'>
        <div className='mx-5 xl:mx-[112px]'>
          <div className='h-[1px] w-full bg-Neutral/200 flex flex-col items-center '>
